...
class Solution:
    """
    这个实现省去了**提前**移除冗余空格的步骤。反转单词和移除空格同时进行。
    """

    def reverse(self, arr: List[str], start: int, end: int) -> None:
        l, r = start, end - 1
        while l < r:
    ...
    def reverseWords(self, s: str) -> str:
        ...
        while i < len(arr):
            if arr[i] == " ":
                ...
                # arr[j] is the space right after the word or the last character of the string.
                # We need to keep that space or break the loop.
                # In either case, i should be j + 1.
                i = j + 1
