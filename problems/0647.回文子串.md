...
https://www.bilibili.com/video/BV17G4y1y7z9/
# 647. 回文子串
...
**《代码随想录》算法视频公开课：[动态规划，字符串性质决定了DP数组的定义 | LeetCode：647.回文子串](https://www.bilibili.com/video/BV17G4y1y7z9)，相信结合视频再看本篇题解，更有助于大家对本题的理解**。
